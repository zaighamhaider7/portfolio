...
$app_description       = $conn->real_escape_string($_POST['app_description'] ?? '');
$app_title = $conn->real_escape_string($_POST['app_title'] ?? '');
$app_title_description    = $conn->real_escape_string($_POST['app_title_description']);
...
$updates[] = "app_description = '$app_description'";
$updates[] = "app_title = '$app_title'";
$updates[] = "app_title_description = '$app_title_description'";
...
$sql = "UPDATE app_uploads SET " . implode(', ', $updates) . " WHERE id = $id";
