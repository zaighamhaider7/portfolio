...
const initialEditData = {
  id: '', software_name: '', software_description: '', software_title: '', software_title_description: '', project_overview_1: '', project_overview_2: '', project_overview_3: '', goal_1: '', goal_2: '', last_description: '', last_heading: '',
  sort_order: '',
  software_banner_image: null, overview_image_1: null, overview_image_1: null, goal_image_1: null, goal_image_2: null, goal_image_3: null, software_front_image: null,
  originalPaths: {}
};

const fileFields = ['software_banner_image', 'overview_image_1', 'overview_image_2', 'goal_image_1', 'goal_image_2', 'goal_image_3', 'software_front_image'];
const fieldMeta = [
  ['software_banner_image', 'Software Banner Image', 'image/*'],
  ...
  ['software_front_image', 'Software Front Image', 'image/*']
];
...
export default function MobileDevTable() {
  ...
  const handleEdit = async (app) => {
    ...
    try {
      const latest = await fetch(`${BASE_URL}/get_sd.php`).then((r) => r.json());
      ...
      setEditData({
        ...
        software_title_description: row.software_title_description || '',
        ...
        software_banner_image: null,
        overview_image_1: null,
        overview_image_2: null,
        goal_image_1: null,
        goal_image_2: null,
        goal_image_3: null,
        software_front_image: null,
        originalPaths
      });
      setIsEditOpen(true);
    } catch (e) {
  ...
  const submitEdit = async () => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/update_sd.php`, { method: 'POST', body: fd });
  ...
  const handleDelete = (id) => {
    ...
    fetch(`${BASE_URL}/delete_sd.php?id=${id}`)
      .then((r) => r.json())
  ...
  return (
    <Box p={3}>
      <Typography variant="h5" gutterBottom>Uploaded Software Entries</Typography>
        ...
        <DialogContent dividers>
          <Stack spacing={2}>
            {[
              ...
              ['software_title_description', 'Software Title Description'],
          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell>Software Title Description</TableCell>
                ...
                <TableCell>Software Image</TableCell>
            ...
            <TableBody>
              {apps.map((app) => (
                <TableRow key={app.id}>
                  ...
                  <TableCell><ScrollCell>{app.software_name}</ScrollCell></TableCell>
                  <TableCell><ScrollCell>{app.software_description}</ScrollCell></TableCell>
                  <TableCell><ScrollCell>{app.software_title}</ScrollCell></TableCell>
                  <TableCell><ScrollCell>{app.software_title_description}</ScrollCell></TableCell>
                  ...
                  <TableCell>
                    {app.software_front_image ? (
                      <img src={`${BASE_URL}/${app.software_front_image}`} width="50" alt="hero" />
                    ) : 'N/A'}
                  </TableCell>
